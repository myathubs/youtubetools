# 📌 MyatHubs AI Notes Logger Setup
# Custom logger for tracking events and errors in the YouTube Notes Generator project
import os, sys
...
logger = logging.getLogger("MyatHubsLogger")
